...
//http://localhost:8080/WebServiceCamel/ebook/item
...
public class EbooItemServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		System.out.println("Subindo servico ebook http://localhost:8080/WebServiceCamel/ebook/item");
	}
